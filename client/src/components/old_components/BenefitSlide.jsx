            ...
            <div className="w-[45%] h-full justify-between pt-2 px-5 flex flex-col">
                ...
                <div className='flex flex-col justify-center  flex-grow'>
                    <div className='flex gap-3'>
                        <span className='text-gray-800 text-2xl'>Share your ideas in</span>
                    ...
                    <div className=" mt-1 text-gray-600 text-[16px] font-light">
                        Talk with your friends about the state of the project and disscus the game plan for further work 
                        also you can do:
                    </div>
                    ...
                    <div className='mt-5'>
                        ...
                        <div className='grid grid-cols-2 gap-3'>
                            <BenefitBlock text="Delete Messages" Icon={() => <HugeiconsIcon size={20} icon={Delete02Icon} />} />
                            <BenefitBlock text="Send Photos" Icon={() => <HugeiconsIcon size={20} icon={Album02Icon} /> }/>
                            <BenefitBlock text="Edit Messages" Icon={() => <HugeiconsIcon size={20} icon={Edit02Icon} />}/>
                            <BenefitBlock text="Ping your friends" Icon={() => <HugeiconsIcon size={20} icon={MentoringIcon} />}/>
                        </div>
                        ...
                        <div className='text-gray-400 font-light'>and everything in real time</div>
                    </div>
                </div>

                {/* Dolna część */}
                <div className='w-full flex justify-center items-end text-gray-600 font-light'>2 / 4</div>
            </div>

            <div className='w-[55%] flex justify-center items-center'>
                <img src="./RTE_ss_4.png"  alt="" />
            </div>
        </div>
    </div>
    )
